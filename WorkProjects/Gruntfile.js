module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      cssmin: {
        with_banner: {
          options: {
            banner: '/* Landing Magic minified CSS*/\n',
          },

          files: {
            'LandingMagic/css/style.min.css' : ['LandingMagic/css/style.css']
          }
        }
      },
      ...
      css: {
          files: ['LandingMagic/css/style.css','src/sass/*.scss'],
          tasks: ['cssmin','sass']
        }
      },
      ...
      sass: {
        dist: {
          options: {
            ...
            files: {
              'LandingMagic/css/style.css': [ // в эту папку получиться скомпелированный и сконкатенированный css файл готовый для продакшена
                  'src/sass/style.scss' 
                   //из этого файла              
                ]
            }
