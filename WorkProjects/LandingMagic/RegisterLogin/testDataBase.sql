...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `userInfoUpdateDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `users` (`userID`, `userLogin`, `userFirstName`, `userLastName`, `userEmail`, `userPhoneNumber`, `userPassword`, `userRegisterDate`, `userInfoUpdateDate`, `userIP`) VALUES
