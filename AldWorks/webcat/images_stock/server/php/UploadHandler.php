    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            // mysql connection settings  
                // 'database' => 'october2012_victor',  
                // 'host' => 'master-study1.netfirmsmysql.com',  
                // 'username' => 'victor',  
                // 'password' => 'victordb', 

           // mysql connection settings  
                // 'database' => 'treid_zafon',  
                // 'host' => 'localhost',  
                // 'username' => 'root',  
                // 'password' => '', 
            // end
...
{  
    $add_to_db = $this->query("INSERT INTO images_repository (images_repository_src) VALUES
...
{  
    $delete_from_db = $this->query("DELETE FROM images_repository WHERE images_repository_src = '$delimg' LIMIT 1") or die(mysql_error());  
    ...
    public function get($print_response = false) {//change to see or hide images after upload
