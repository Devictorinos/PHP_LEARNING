...
$t = new Test();
//$orders = $db->select('orders','o', ['*'])->getAll(true);


// $empl = $dbh->prepare("SHOW COLUMNS FROM employees ");
// $empl->execute();
// $e = $empl->fetchAll(PDO::FETCH_ASSOC);
...
$products1   = $db->select('products', 'pp', ['ProductName as PPname']);
 ...
 $products->whereBetween1('ProductID', ">", 25);
  $products->where1('ProductID', ">", 25);
 $products->where3('ProductID', ">", 25);
...
/*include "db/DBC.Class.php";
include "register/RegisterClass.php";

$db = new DBC("localhost", "northwind", "root", "123");
