...
$sql = mysql_query("SELECT OrderID, CustomerID, EmployeeID FROM orders ORDER BY OrderID ASC");
...
$sql2 = mysql_query("SELECT OrderID, CustomerID, EmployeeID FROM orders ORDER BY OrderID ASC $limit"); 
...
while($row = mysql_fetch_array($sql2)){ 
    ...
    $id = $row["OrderID"];
    $firstname = $row["CustomerID"];
    $country = $row["EmployeeID"];
